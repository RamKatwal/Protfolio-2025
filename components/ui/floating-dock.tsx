...
const FloatingDockDesktop = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "hidden md:flex gap-4 rounded-2xl bg-gray-50 px-4 pb-3 dark:bg-neutral-900",
...
function IconContainer({
  ...
  const motionContent = (
    <motion.div
      ...
      className="relative flex aspect-square items-center justify-center rounded-full bg-gray-200 dark:bg-neutral-800 border border-gray-300"
    >
      <AnimatePresence>
        {hovered && (
          <motion.div
